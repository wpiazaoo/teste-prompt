...
Segue abaixo a lista dos cenários de testes que realizei correspondentes aos prints. Eles estão nomeados e enumerados conforme a listagem abaixo
 1. Primeira interação Mia: uso de Handlebars para identifação do cliente.
 ...
 4. Sem resposta a primeira interação
 5. Sem resposta ao documento solicitado
 6. Reposta com um dado não solicitado
 7. Manipulação do prompt
 8. Questionar documento
